export const ProductService = {
    getProductsData() {
        return [
            ...
            },
            {
                ...
                partNumber:'22186',
                lampImage: 'black-watch.jpg',
                location:'Graphics Panel',
                caseQuantity:30,
                price: 7200,
                category: 'Accessories',
                quantity: 61,
            ...
            },
            {
                ...
                partNumber:'12678',
                lampImage: 'brown-purse.jpg',
                location:'Behind Stove',
                locationColor : 'Blue',
                maxQuatity : 10,
                caseQuantity:25,
                isRecycle : 'Yes',
            ...
            },
            {
                ...
                partNumber:'21009',
                lampImage: 'galaxy-earrings.jpg',
                location:'Entry sales floor',
    ...
    async getSingleProduct(id){
        return Promise.resolve(this.getProductsData().filter(res => res.id == id));
    },
    ...
    getProductsWS() {
        return Promise.resolve(this.getProductsData().slice(5, 10));
    },
